  ...
  return (
    <section className='py-24 px-6 bg-black'>
      <div className='max-w-5xl mx-auto'>
        <h2 className='text-5xl font-bold text-center mb-20 bg-linear-to-r from-purple-300 to-purple-600 bg-clip-text text-transparent'>
          My career & experience
        </h2>

        <div ref={ref} className='relative flex'>
          {/* Track line */}
          <div className='relative w-0.5 mr-10 bg-white/10 rounded-full'>
            <motion.div
              style={{ height: lineHeight }}
              className='absolute top-0 left-0 w-0.5 rounded-full bg-linear-to-b from-purple-300 via-purple-500 to-purple-900/0'
            />
            {/* Comet head glow */}
            <motion.div
